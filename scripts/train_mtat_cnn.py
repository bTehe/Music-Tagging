...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train short-chunk CNN on MTAT log-mel.")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("artifacts/runs/mtat_cnn_baseline"))
...
def main() -> None:
    ...
    model = ShortChunkCNN(num_tags=len(tag_names)).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        val_metrics = multilabel_metrics(val_out.y_true, val_out.y_prob, tag_names=tag_names)
